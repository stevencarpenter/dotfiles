...
sketchybarrc="${repo_root}/home/.config/sketchybar/sketchybarrc"
workspaces_item="${repo_root}/home/.config/sketchybar/items/workspaces.sh"
aerospace_plugin="${repo_root}/home/.config/sketchybar/plugins/aerospace.sh"
badge_plugin="${repo_root}/home/.config/sketchybar/plugins/app_badge.sh"
# machine.env is no longer a chezmoi template; it is generated by nix from
# lib/machines.nix (caps.sketchybar_workspace_badges). Assert the generator
# still emits the toggle the plugin reads.
badge_generator="${repo_root}/modules/home/tiling.nix"
...
assert_contains "${badge_generator}" \
  ...
  "expected tiling.nix to generate machine.env with the workspace badge toggle"
...
cp "${repo_root}/home/.config/sketchybar/plugins/icon_map.sh" "${tmpdir}/plugins/icon_map.sh"
